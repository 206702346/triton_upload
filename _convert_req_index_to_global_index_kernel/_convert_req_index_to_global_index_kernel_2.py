...
def triton_convert_req_index_to_global_index(
    ...
    BLOCK_N: int = 256,               # tuned for better occupancy on Ascend 910B
):
    ...
    _convert_req_index_to_global_index_kernel[grid](
        ...
        out_stride0,
        out_stride1,
        num_warps=4,   # reduced from 8 to match smaller BLOCK_N and improve occupancy
        num_stages=2,  # lower pipeline depth reduces latency
    )
    return out