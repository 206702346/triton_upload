...
def _unpack_seq_triton_kernel(
    ...
    base_packed_off = pid * Lmax * D
    base_out_off = cum_len_start * D
    ...
    for t_start in range(0, seq_len, BLOCK_T):
        ...
        for d_start in range(0, D, BLOCK_D):
            ...
            packed_offset = base_packed_off + t_times_D[:, None] + d_idx[None, :]
            out_offset = base_out_off + t_times_D[:, None] + d_idx[None, :]
